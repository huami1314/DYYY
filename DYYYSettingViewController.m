...
@property (nonatomic, assign) BOOL isDanmuColorEnabled;
@end
...
- (void)setupSettingItems {
    ...
    NSMutableArray *section4 = [NSMutableArray arrayWithObject:[DYYYSettingItem itemWithTitle:@"开启弹幕改色" key:@"DYYYEnableDanmuColor" type:DYYYSettingItemTypeSwitch]];
    
    if (self.isDanmuColorEnabled) {
        [section4 addObject:[DYYYSettingItem itemWithTitle:@"修改弹幕颜色" key:@"DYYYdanmuColor" type:DYYYSettingItemTypeTextField placeholder:@"十六进制颜色"]];
    }
...
- (void)addTitleGradientAnimation {
    ...
    gradient.colors = @[(id)[UIColor systemRedColor].CGColor, (id)[UIColor systemBlueColor].CGColor];
    ...
    colorChange.toValue = @[(id)[UIColor systemYellowColor].CGColor, (id)[UIColor systemGreenColor].CGColor];
