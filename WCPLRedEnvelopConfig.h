...
@property (nonatomic, assign) BOOL gamePlugEnablei;

@property (nonatomic, assign) BOOL newFeatureEnable; 

@property (assign, nonatomic) BOOL personalRedEnvelopEnable;

@property (assign, nonatomic) BOOL autoLoginEnable;

@property (assign, nonatomic) BOOL adBlockerEnable;
