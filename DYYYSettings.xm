        ...
        dyyyItem.cellTappedBlock = ^{
            ...
            uiSettingItem.cellTappedBlock = ^{
                ...
                NSArray *transparencySettings = @[
                    ...
                    @{@"identifier": @"DYYYGlobalTransparency", @"title": @"设置全局透明", @"detail": @"0-1的小数", @"cellType": @26, @"imageName": @"ic_eyeslash_outlined_20"},
                ...
                NSArray *titleSettings = @[
                    @{@"identifier": @"DYYYIndexTitle", @"title": @"设置首页标题", @"detail": @"不填默认", @"cellType": @26, @"imageName": @"ic_docpen_filled"},
