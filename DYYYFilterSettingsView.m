...
- (instancetype)initWithTitle:(NSString *)title text:(NSString *)text {
  if (self = [super initWithFrame:UIScreen.mainScreen.bounds]) {
    ...
    self.keywordFilterButton.tintColor = [UIColor colorWithRed:11/255.0 green:223/255.0 blue:154/255.0 alpha:1.0]; // #0BDF9A
    ...
    self.selectionPreviewLabel.backgroundColor = [UIColor colorWithRed:245/255.0 green:245/255.0 blue:245/255.0 alpha:1.0];
    ...
    self.charactersScrollView.backgroundColor = [UIColor colorWithRed:245/255.0 green:245/255.0 blue:245/255.0 alpha:1.0];
...
- (void)setupCharacterButtons {
  ...
  for (NSInteger i = 0; i < self.text.length; i++) {
    ...
    [button setTitleColor:[UIColor colorWithRed:45/255.0 green:47/255.0 blue:56/255.0 alpha:1.0] forState:UIControlStateNormal];
...
- (void)updateSelectionWithStartIndex:(NSInteger)startIdx endIndex:(NSInteger)endIdx {
  ...
  for (NSInteger i = startIndex; i <= endIndex; i++) {
    if (i < self.characterButtons.count) {
      ...
      button.backgroundColor = [UIColor colorWithRed:11/255.0 green:223/255.0 blue:154/255.0 alpha:0.2]; // 浅绿色背景
